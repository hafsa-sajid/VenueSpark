  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      if (result.status === 200) {
        toast.success("OTP sent to your email!", { style: { height: "50px", width: "300px" } });
  ...
  return (
    <div className='min-h-screen w-full flex bg-transparent transition-colors duration-500 overflow-hidden relative'>
      ...
      <div className='hidden lg:flex w-1/2 relative flex-col items-center justify-center p-12 bg-transparent border-r border-white/5 shadow-2xl'>
          ...
          <div className='relative z-10 flex flex-col items-center text-center animate-pop-3d'>
              ...
              <p className='text-slate-400 text-xl font-medium max-w-md leading-relaxed'>
                  Don't worry, even the best celebrations need a little backup. Let's get you back into your account.
              </p>
          </div>
      ...
      <div className='w-full lg:w-1/2 flex items-center justify-center relative p-6 bg-transparent transition-colors duration-500'>
          ...
          <form className='glass-card max-w-[480px] w-full p-10 md:p-14 flex flex-col gap-8 relative' onSubmit={handleForgotPassword}>
              <div className='w-full text-center'>
                ...
                <h1 className='text-4xl font-black text-white tracking-tighter leading-none'>Forgot Password</h1>
                <p className='text-slate-500 text-sm font-medium mt-4 uppercase tracking-[2px]'>Enter your email to reset password</p>
              </div>
      
              <div className='w-full space-y-4'>
                  <label htmlFor="email" className='text-[10px] font-black uppercase tracking-[3px] text-slate-500 ml-1'>Email Address</label>
              ...
              <p className='text-center text-sm font-bold text-slate-500 mt-4'>
                  Remember password? <span className='text-[#8B5CF6] font-black cursor-pointer hover:underline uppercase tracking-widest text-xs' onClick={()=>navigate("/login")}>Login instead</span>
              </p>
          </form>
      </div>
    </div>
