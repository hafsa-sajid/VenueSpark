  ...
  const handleVerifyResetOTP = async (e) => {
    ...
    try {
      ...
      if (result.status === 200) {
        toast.success("OTP Verified! Proceed to reset password.", { style: { height: "50px", width: "300px" } });
  ...
  return (
    <div className='min-h-screen w-full flex bg-transparent transition-colors duration-500 overflow-hidden relative'>
      ...
      <div className='hidden lg:flex w-1/2 relative flex-col items-center justify-center p-12 bg-transparent border-r border-white/5 shadow-2xl'>
          ...
          <div className='relative z-10 flex flex-col items-center text-center animate-pop-3d'>
              ...
              <p className='text-slate-400 text-xl font-medium max-w-md leading-relaxed'>
                  Security first. Verify your identity to regain access to your account and continue your journey.
              </p>
          </div>
      ...
      <div className='w-full lg:w-1/2 flex items-center justify-center relative p-6 bg-transparent transition-colors duration-500'>
          ...
          <form className='glass-card max-w-[480px] w-full p-10 md:p-14 flex flex-col gap-8 relative' onSubmit={handleVerifyResetOTP}>
              <div className='w-full text-center'>
                ...
                <h1 className='text-4xl font-black text-white tracking-tighter leading-none'>Verify OTP</h1>
              ...
              <div className='w-full space-y-4'>
                  <label htmlFor="otp" className='text-[10px] font-black uppercase tracking-[3px] text-slate-500 text-center block'>Reset Code</label>
                  <input 
                    type="text" 
                    id='otp' 
              ...
              <p className='text-center text-sm font-bold text-slate-500 mt-4'>
                  Didn't receive the code? <span className='text-[#8B5CF6] font-black cursor-pointer hover:underline uppercase tracking-widest text-xs'>Resend</span>
              </p>
          </form>
      </div>
    </div>
